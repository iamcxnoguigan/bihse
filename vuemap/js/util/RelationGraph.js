...
import {Relationship_extraction} from '../util/xmlRelationGraph'
export {drawChart}
...
var handle_dataInput = function () {
  ...
  for (var i in relation) {
    relation[i].lineStyle = dataInput.relation_category.default.lineStyle
	    ...
	    series: [
	        {
	            ...
	            force: {
		            ...
		            gravity: 0.2, // 节点受到中心的引力因子
		            edgeLength: 600 // 节点之间的距离
